...
class AppFunctions(MainWindow):
    def setThemeHack(self):
        Settings.BTN_LEFT_BOX_COLOR = "background-color: #6a7cb1;"
        Settings.BTN_RIGHT_BOX_COLOR = "background-color: #6a7cb1;"
        ...
        self.ui.commandLinkButton.setStyleSheet("color: #9eb0ff;")